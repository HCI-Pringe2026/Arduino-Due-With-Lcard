...
Пример:
    python koger.py \
        --folder "experiments/Казаков А" "experiments/Иванов Б"
...
def load_metadata_and_data(
    ...
    #
    # ВАЖНО:
    # Здесь нельзя вручную задавать список columns.
    #
    # В вашем реальном файле после # DATA находится TSV-заголовок
    # примерно на 40 колонок. pandas должен сам прочитать этот заголовок.
    # ------------------------------------------------------------------------
